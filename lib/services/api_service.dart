...
// ❌ NE PAS utiliser 'const' car getBaseUrl() n'est pas une constante
// const String API_BASE_URL = getBaseUrl(); // ERREUR
// ✅ Utilisez simplement une variable
String API_BASE_URL = getBaseUrl(); // CORRECTION
...
class ApiService {
  ...
  Future<Map<String, dynamic>> fetchDistributorStats() async {
    ...
    try {
      // ❌ ANCIENNE URL (404) :
      // final url = Uri.parse('$API_BASE_URL/distributor/stats');

      // ✅ NOUVELLE URL (corrigée selon les routes disponibles) :
  ...
  Future<List<String>> fetchWilayas() async {
    ...
    try {
      ...
      // Retourne la liste statique en cas d'erreur
      return [
        'Adrar', 'Chlef', 'Laghouat', 'Oum El Bouaghi', 'Batna', 'Béjaïa', 'Biskra',
        'Béchar', 'Blida', 'Bouira', 'Tamanrasset', 'Tébessa', 'Tlemcen', 'Tiaret',
        'Tizi Ouzou', 'Alger', 'Djelfa', 'Jijel', 'Sétif', 'Saïda', 'Skikda', 'Sidi Bel Abbès',
